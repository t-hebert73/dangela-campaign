                        ...
                        <div class="card mb-3">
                            ...
                            <div v-if="!loading" class="card-body">
                                <div class="card-title">
                                    <h1 class="float-left">Sign Request</h1>
                                    <!-- <router-link :to="{ name: 'sign-requests.index'}" class="btn btn-primary float-right">Back</router-link>-->
                                    ...
                                    <div class="col-12">
                                            ...
                                            <b-card no-body align="center">
                                                ...
                                                <b-card-body>
                                                    <div class="card-text data-value">
                                                        {{ moment(signRequest.created_at).format('MMM Do YYYY') }}
                                                    </div>
                                                </b-card-body>
                                            </b-card>
                                        ...
                                        <b-card-group class="mt-4" deck>
                                            ...
                                            <b-card no-body align="center">
                                                ...
                                                <b-card-body>
                                                    <div class="card-text data-value">
                                                        {{ signRequest.street_number + ' ' + signRequest.street_address }}
                                                    </div>
                                                </b-card-body>
                                            </b-card>
...
<script>
  export default {
    ...
    methods: {
       ...
       */
      getsignRequest (id) {
        window.axios.get(this.API_ROUTE + 'sign-requests/' + id).then(response => {
          this.signRequest = response.data.signRequest
          this.loading = false
