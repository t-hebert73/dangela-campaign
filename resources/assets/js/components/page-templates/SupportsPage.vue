    ...
    <div class="container">
        <div class="main-area">
            ...
            <div class="page-content">
                ...
                <ul class="mb-5">
                    <li>local government being open and transparent</li>
                    <li>stable, responsible taxes reflect real needs, not political wish lists</li>
                    <li>Council remaining accountable throughout its term of office</li>
                    <li>where all of our citizens can be heard and know they are part of the process</li>
                    <li>honesty and integrity at Regional Government</li>
